...
public class RedisUtil {
     ...
     */
    public boolean setHashAdd(String key, String item, Object value) {
        try {
     ...
     * @return true 成功 false失败
     */
    public boolean setHashAdd(String key, String item, Object value, long time) {
        try {
            redisTemplate.opsForHash().put(key, item, value);
            if (time > 0) {
                expire(key, time);
     ...
     * @return true 存在 false不存在
     */
    public boolean isSetValue(String key, Object value) {
        try {
     ...
     * @return
     */
    public boolean setList(String key, Integer index, Object value) {
        try {
     ...
     * @param values     待添加的数据
     */
    public void setListRight(String listKey, Object... values) {
        // 绑定操作
     ...
     * @param values     待添加的数据
     */
    public void setListRight(String listKey, ExpireEnum expireEnum, Object... values) {
        // 绑定操作
        BoundListOperations<String, Object> boundValueOperations = redisTemplate.boundListOps(listKey);
        // 插入数据
        boundValueOperations.rightPushAll(values);
     ...
     * @param values     待添加的数据
     */
    public void setListLeft(String listKey, Object... values) {
        // 绑定操作
        BoundListOperations<String, Object> boundValueOperations = redisTemplate.boundListOps(listKey);
        // 插入数据
     ...
     * @param values     待添加的数据
     */
    public void setListLeft(String listKey, ExpireEnum expireEnum, Object... values) {
        // 绑定操作
        BoundListOperations<String, Object> boundValueOperations = redisTemplate.boundListOps(listKey);
        // 插入数据
        boundValueOperations.leftPushAll(values);
    ...
    public static enum ExpireEnum {
        // 未读消息的有效期为30天
        DAY1(30L, TimeUnit.DAYS), DAY5(5L, TimeUnit.DAYS), DAY10(10L, TimeUnit.DAYS), DAY30(30L, TimeUnit.DAYS), // 30天
        SECONDS60(60L, TimeUnit.SECONDS), // 60秒
        SECONDS3600(60 * 60L, TimeUnit.SECONDS),// 1小时
        ;
